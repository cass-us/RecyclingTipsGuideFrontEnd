...
const HeroSection = () => {
  ...
  const slides = [
    { type: "image", src: re1, alt: "Image 1", text: "Welcome to RecyclingGuide" },
    { type: "image", src: re2, alt: "Image 2", text: "Recycle and Save the Planet" },
    { type: "image", src: re3, alt: "Image 3", text: "Join the Green Movement" },
  ];
